...
#ifndef ZEPHYR_EXT_LIB_GUI_LVGL_LV_CONF_H_
#define ZEPHYR_EXT_LIB_GUI_LVGL_LV_CONF_H_
...
#define LV_MEM_CUSTOM_INCLUDE	<gui/lvgl_mem.h>
...
#endif /* ZEPHYR_EXT_LIB_GUI_LVGL_LV_CONF_H_ */
